...
use crate::domain::valueobjects::{AccountToRoomMessageId, MessageContent, MessageTopic, RoomId};

#[derive(Debug, Clone)]
pub struct AccountToRoomRawMessage {
...
impl<'r> sqlx::FromRow<'r, sqlx::postgres::PgRow> for AccountToRoomRawMessage {
  fn from_row(row: &'r sqlx::postgres::PgRow) -> Result<Self, sqlx::Error> {
    Ok(AccountToRoomRawMessage {
...
impl AccountToRoomRawMessage {
  pub fn new(
    id: AccountToRoomMessageId, room_id: RoomId, account_id: AccountId, topic: MessageTopic, content: MessageContent,
    created_at: chrono::DateTime<chrono::Utc>,
  ) -> Self {
    Self {
      id,
